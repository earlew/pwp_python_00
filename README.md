...
## Test case 1: Beaufort Sea in the summer

This test case uses data from *met_beaufort.nc* and *profile_beaufort.nc*, which contain summertime data<sup>*</sup> from the Beaufort Sea. These example files were kindly provided by Sarah Dewey. The following solutions are generated by doing the following:
...
Alternatively, you can run the `run_demo1()` function in *PWP_helper.py*. The first series of plots show the interpolated surface fluxes from *met_beaufort.nc*.
